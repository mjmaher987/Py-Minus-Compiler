...
class Lexer:
    ...
    def fill_pars_table(self):
        self.pars_table = {"Program": {"break": "Statements", "continue": "Statements", "ID": "Statements",
                           ...
                           "B": {"=": "= C", "(": "( Arguments ) #output_call", ";": "SYNCH", "[": "[ Expression #array_address ] = C"},
                           ...
                           "Return_stmt": {"return": "return #return_enable Return_Value #return_back", ";": "SYNCH"},
                           "Return_Value": {";": "#push_nothing EPSILON", "ID": "Expression", "NUM": "Expression"},
                           "Global_stmt": {"global": "global #global_id #pid ID", ";": "SYNCH"},#global id
                           "Function_def": {"def": "def #declare_function ID ( Params ) : Statements #return_back #outside_func", ";": "SYNCH"},#todo id for function
                           ...
                           "Relational_Expression": {"ID": "Expression Relop Expression #relop",#todo check relop and next 2 lines!!!!!
                                                     "NUM": "Expression Relop Expression #relop", ":": "SYNCH", ")": "SYNCH"},
                           ...
                           "Primary": {";": "EPSILON", "[": "[ Expression #array_address ] Primary", "]": "EPSILON",
                                       "(": "( Arguments #jump_to_function #prv ) Primary", ")": "EPSILON", ",": "EPSILON", ":": "EPSILON",
                                       "==": "EPSILON", "<": "EPSILON", "+": "EPSILON", "-": "EPSILON", "*": "EPSILON"},
                           "Arguments": {"ID": "Expression #param_function Arguments_Prime #pop #jump_to_function", ")": "#jump_to_function EPSILON",
                                         "NUM": "Expression #param_function Arguments_Prime #pop #jump_to_function"},
                           "Arguments_Prime": {")": "EPSILON", ",": ", Expression #param_function Arguments_Prime"},
